...
export default function Home() {
  ...
  const [query, setQuery] = useState(
    "Compare Notion vs Coda vs ClickUp for project management"
  );
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300">
              7 AI agents working together to deliver comprehensive competitive
              intelligence
            </p>
          </div>
          ...
          <form
            ...
            className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700 shadow-2xl"
          >
            <div className="mb-6">
              <label
                htmlFor="query"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 disabled:from-gray-600 disabled:to-gray-600 text-white font-semibold py-4 px-6 rounded-lg transition-all transform hover:scale-105 disabled:scale-100 disabled:cursor-not-allowed shadow-lg"
            >
              {loading ? (
          ...
          <div className="mt-8 text-center text-sm text-gray-400">
            <p>
              Powered by 7 specialized AI agents using LangGraph orchestration
            </p>
          </div>
        </div>
      </div>
