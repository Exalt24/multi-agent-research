...
const AGENTS = [
  ...
  },
  {
    ...
    description: "Researches funding and growth",
  },
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-900 via-blue-900 to-gray-900 text-white">
      <div className="container mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Research in Progress</h1>
        ...
        {workflowComplete && finalResults && (
          <div className="mt-8 bg-linear-to-br from-green-900/30 to-blue-900/30 backdrop-blur-sm rounded-xl p-8 border border-green-700/50">
            ...
            {/* Competitor Profiles */}
            {finalResults.competitor_profiles &&
              Object.keys(finalResults.competitor_profiles).length > 0 && (
                <div className="mb-6">
                  ...
                  <div className="space-y-4">
                    {Object.entries(finalResults.competitor_profiles).map(
                      ([company, profile]: [
                        ...
                        >
                          <h4 className="text-xl font-bold text-blue-400 mb-4 border-b border-blue-900 pb-2">
                            {company}
                          </h4>
                          <div className="prose prose-invert max-w-none">
                            <ReactMarkdown
              ...
              <button
                onClick={() => {
                  ...
                  if (finalResults.comparative_analysis?.analysis_text) {
                    ...
                    markdownContent +=
                      finalResults.comparative_analysis.analysis_text + "\n\n";
                  }
